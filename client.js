window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region dsh-grok-oauth: dedicated "Grok OAuth 登录" settings module
		const GROK_AUTH_SECTION_ID = "grok-oauth-login";
		const GROK_AUTH_ITEM_SLOT = "settings.grok.auth";
		const GROK_AUTH_LOCALE_NS = "settings.grok-auth";
		const grokAuthCopy = {
			zh: {
				nav: "Grok OAuth 登录",
				title: "Grok OAuth 登录",
		...
		function GrokAuthSection(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-grok-auth-section": GROK_AUTH_LOCALE_NS,
				style: pageStyle,
		...
		*/
		...
		function apply(ctx) {
			...
			ctx.slots.inject(GROK_AUTH_ITEM_SLOT, () => ctx.slots.register({
